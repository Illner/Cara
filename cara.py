...
def create_parser() -> argparse.ArgumentParser:
    ...
    parser_temp.add_argument("-fil",
                             ...
                             action="store",
                             default=il_enum.FirstImpliedLiteralsEnum.IMPLICIT_BCP.name,
                             type=str,
                             choices=il_enum.first_implied_literals_enum_names,
                             help="type of method that will be used for deriving implied literals after component decomposition")
    ...
    parser_temp.add_argument("-hplnc",
    ...
    parser_temp.add_argument("-hplnv",
