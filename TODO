...
from tests.circuit.circuit.circuit_test import CircuitTest
...
# path = r"D:\Storage\OneDrive\Škola\Vysoká škola\UK\SAT benchmarks\D4\Handmade\ais\ais6.cnf"

start_time = time.time()

cnf = Cnf(path)

compiler = Compiler(cnf, smooth=False, ub_factor=0.1, new_cut_set_threshold=0.1,
