...
class ExperimentEnum(str, Enum):
    ...
    DNNF_D4_COMPONENT_CACHING_BEFORE = r"DNNF\D4 (component caching before)"
    DNNF_D4_COMPONENT_CACHING_BEFORE_AND_AFTER = r"DNNF\D4 (component caching before and after)"
