    ...
    for i, (file_name, file_path) in enumerate(experiment._files):
        ...
        try:
            experiment.experiment(file_name=file_name, file_path=file_path,
                                  ...
                                  decision_heuristic_maximum_renamable_horn_objective_function=lpfof_enum.LpFormulationObjectiveFunctionEnum.SQUARED_INVERSE_LENGTH_WEIGHTED_HORN_FORMULA,
